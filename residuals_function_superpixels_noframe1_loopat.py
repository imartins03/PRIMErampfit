...
# Process each superpixel and degree to generate residuals and statistics
for center in centers:
    for degree in range(1, 11):  # Degrees from 1 to 10
        residuals_cube = calculate_residuals_for_superpixel(center, degree)
        print(f'Processed superpixel at center {center} for degree {degree}')
