...
def evaluate_leguerre_poly(coeffs, x):
...
def generate_fit_cube(degree, saturation=50000, n_frames=n_frames, num_rows=4):
    ...
    output_dir = f'F:/laguerrefit/{n_frames}_frames_unweighted'
    ...
    for i in range(num_rows):
        ...
        #unweighted
        coefficients = np.polynomial.laguerre.lagfit(time, y_row, degree)
        ...
        fit_cube_row = evaluate_leguerre_poly(coefficients, time)
