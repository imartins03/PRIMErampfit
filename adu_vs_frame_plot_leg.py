...
data_directory = f'F:\legfit\{n_frames}_frames'
...
for degree in range(1, 11):
    ...
    residuals_cube_path = os.path.join(data_directory, f'res_cube_leg_{n_frames}frames_{degree}deg_final_vst.fits')
    ...
    # Save the plot
    plot_filename = os.path.join(data_directory, f'median_residuals_plot_leg_{n_frames}frames_{degree}deg.png')
