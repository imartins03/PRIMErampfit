...
def compute_and_save_residuals_for_first_degree():
    ...
    file_poly = os.path.join(input_dir_poly, r"F:\leftover_C1_dif_degrees_test_rampfit\239_frames\unweighted\fit_cube_poly_6deg_239frames_noframe1.fits")
    file_leg = os.path.join(input_dir_leg, r"F:\legfit\239_frames_unweighted\fit_cube_leg_239frames_6deg_final_vst_unweighted.fits")
    ...
    residual_file = os.path.join(output_dir_residuals, f'residuals_fit_degree_{degree}.fits')
