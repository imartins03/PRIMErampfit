...
def calculate_residuals(degree, n_frames=239):
    ...
    fit_cube_path = f'F:/laguerrefit/{n_frames}_frames_unweighted/fit_cube_lag_{n_frames}frames_{degree}deg_final_vst_unweighted.fits'
    residuals_cube_path = f'F:/laguerrefit/{n_frames}_frames_unweighted/res_cube_lag_{n_frames}frames_{degree}deg_final_vst_unweighted.fits'
    stat_table = f'F:/laguerrefit/{n_frames}_frames_unweighted/frame_statistics_lag_{n_frames}frames_{degree}deg_unweighted.csv'
    # "F:\laguerrefit\239_frames_unweighted\fit_cube_lag_239frames_1deg_final_vst_unweighted.fits"
